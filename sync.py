...
# IMPORTANT:
# I can’t see your exact Anthropic Admin API base URL / endpoints from here.
# Put the correct base URL + endpoints from your Anthropic Admin API docs.
...
def normalize_usage(payload: dict):
    """
    This function is intentionally defensive because orgs/plans can differ.
    You’ll adjust the field extraction once you see real payload shape.
    """
    rows = []
    ts = iso_now()
